...
const INTRO_KEY = "lumenIntroSeen";
...
if (intro) {
  ...
  const shouldShowIntro =
    ...
    (!isSameOriginReferrer && !introSeen);
...
const isMobileViewport =
  ...
  let servicesModal = document.querySelector(".contact-modal");
  let servicesOverlay = document.querySelector(".contact-modal-overlay");
  let servicesClose = document.querySelector(".contact-modal-close");
  ...
  function ensureServicesModal() {
    ...
    servicesModal = document.querySelector(".contact-modal");
    servicesOverlay = document.querySelector(".contact-modal-overlay");
    servicesClose = document.querySelector(".contact-modal-close");
    if (servicesOverlay) {
